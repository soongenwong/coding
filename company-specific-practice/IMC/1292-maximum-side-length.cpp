...
// This solution implements an efficient technique—prefix sum—to quickly find the largest square submatrix whose sum doesn't exceed the threshold. It checks from the biggest to smallest possible side, returning the answer as soon as a solution is found. This drastically improves performance compared to checking each sub-square’s sum directly.