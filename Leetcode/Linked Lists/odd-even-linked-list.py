class Solution:
   def oddEvenList(self, head: Optional[ListNode]) -> Optional[ListNode]:
       ...
       # initial plan
       # use next to add the next value. 
       # group odd indices together first, then move to the even indices. 

       # final solution
       # initialise the odd and even postions. 
       # make sure that even has a next position. 
